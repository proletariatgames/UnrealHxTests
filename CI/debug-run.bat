...
REM "%VS140COMNTOOLS%\..\IDE\devenv.exe" /DebugExe "%UE4%/Engine/Binaries/Win64/UE4Editor.exe" "%WORKSPACE%/HaxeUnitTests.uproject" -run=HaxeUnitTests.UpdateAsset "2017-05-10_0223 AM" || exit /b 1
