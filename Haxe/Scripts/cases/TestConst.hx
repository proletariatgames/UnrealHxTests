...
class UHaxeConst extends UBasicTypesUObject {
  ...
  override public function testConstParam(geo:unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>) : unreal.FString {
    return "OVERRIDE " + super.testConstParam(geo);
  }

  override private function testConstParam_protected(geo:unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>) : unreal.FString {
  ...
  public function doTestConstParam_protected(geo:unreal.Const<unreal.PRef<unreal.slatecore.FGeometry>>) : unreal.FString {
